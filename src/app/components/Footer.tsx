    ...
    <div className="container bg-[#111111] text-white p-[30px] rounded-xl">
      ...
      <div className="flex  flex-col gap-14">
        ...
        <div className="flex flex-col gap-5 text-primary">
          <p className="text-black dark:text-white font-medium">Social Media</p>
          <div className="flex gap-5">
            <Link href={"https://www.instagram.com/gulomoov_1"} target="blank">
            ...
            <Link href={"https://www.youtube.com/@gulomoov__1"} target="blank">
